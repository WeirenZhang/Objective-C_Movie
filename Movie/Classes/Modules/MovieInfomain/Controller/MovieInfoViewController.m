         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MovieInfoCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    
    if (!cell) {
        cell = [[MovieInfoCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
    }
    MovieInfoModel *listItem = self.viewModel.listData[indexPath.row];
