...
@interface MovieDateView () <UITableViewDelegate,UITableViewDataSource>

//@property (nonatomic, weak) id<DateViewProtocol> delegate;
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) UIView *transparentView;
/// viewModel
@property (strong, nonatomic) MovieTimeTabsViewModel *viewModel;
...
@implementation MovieDateView

+ (instancetype)bindViewWithViewModel:(id)viewModel {
    MovieDateView *view = [[self alloc] init];
...
- (void)configViewModel {
    ...
    [self.disposees addObject:
     self.viewModel.refreshSignal(@"MovieDateView").deliverOnMainThread.subscribeNext(^(NSNumber *value) {
        @strongify(self);
