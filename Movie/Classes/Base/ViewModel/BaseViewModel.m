...
@property (nonatomic,weak) UIViewController<ViewControllerProtocol> *viewModelController;
...
+ (instancetype)viewModelWithParameter:(NSDictionary *)parameter {
    BaseViewModel *viewModel = [[self alloc] init];
...
- (void)viewModelLoad {
    self.emptyType = EmptyType_NoStatus;
}

- (void)setViewModelController:(UIViewController<ViewControllerProtocol> *)viewModelController {
...
- (UIViewController<ViewControllerProtocol> *)viewModelController {
